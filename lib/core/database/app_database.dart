...
class Notes extends Table {
  ...
  TextColumn get plainText => text().withDefault(const Constant(''))(); // for search
...
class Budgets extends Table {
  ...
  IntColumn get categoryId => integer()
      .nullable()
      .references(ExpenseCategories, #id, onDelete: KeyAction.cascade)();
...
class Medicines extends Table {
  ...
  IntColumn get profileId => integer()
      .nullable()
      .references(MedicineProfiles, #id, onDelete: KeyAction.cascade)();
  TextColumn get name => text()();
...
@DriftDatabase(tables: [
  ...
  Projects, Tasks, TaskTags,
  Habits, HabitLogs,
  Accounts, ExpenseCategories, Expenses, Budgets, RecurringExpenses,
  MedicineProfiles, Medicines, MedicineDoses, SymptomLogs,
  FocusSessions,
])
  ...
  Future<void> _seedDefaults() async {
    await batch((b) {
      b.insertAll(accounts, const [
        AccountsCompanion(
            name: Value('Cash'), type: Value('cash'), color: Value(0xFF3BB273)),
        AccountsCompanion(
            name: Value('bKash'), type: Value('bkash'), color: Value(0xFFE2136E)),
        AccountsCompanion(
            name: Value('Nagad'), type: Value('nagad'), color: Value(0xFFEE7623)),
        AccountsCompanion(
            name: Value('Bank'), type: Value('bank'), color: Value(0xFF5B7CE0)),
      ]);
      b.insertAll(expenseCategories, const [
        ExpenseCategoriesCompanion(
            name: Value('Food'), icon: Value('food'), color: Value(0xFFE5484D)),
        ExpenseCategoriesCompanion(
            name: Value('Transport'),
            icon: Value('transport'),
            color: Value(0xFF5B7CE0)),
        ExpenseCategoriesCompanion(
            name: Value('Bills'), icon: Value('bills'), color: Value(0xFFF2A03D)),
        ExpenseCategoriesCompanion(
        ...
        ExpenseCategoriesCompanion(
            name: Value('Health'), icon: Value('health'), color: Value(0xFFEC4899)),
        ExpenseCategoriesCompanion(
        ...
        ExpenseCategoriesCompanion(
            name: Value('Family'), icon: Value('family'), color: Value(0xFF14B8A6)),
        ExpenseCategoriesCompanion(
            name: Value('Other'), icon: Value('other'), color: Value(0xFF6C6C6C)),
        ExpenseCategoriesCompanion(
            name: Value('Salary'),
            icon: Value('salary'),
            color: Value(0xFF3BB273),
      ...
      b.insert(
        ...
        const MedicineProfilesCompanion(
            name: Value('Self'), relation: Value('Self')),
      );
      b.insertAll(projects, const [
        ProjectsCompanion(
            name: Value('Inbox'), icon: Value('inbox'), color: Value(0xFF6C6C6C)),
        ProjectsCompanion(
            name: Value('Personal'),
            icon: Value('home'),
            color: Value(0xFF3BB273)),
        ProjectsCompanion(
            name: Value('Work'), icon: Value('work'), color: Value(0xFF5B7CE0)),
      ]);
    });
  }
}
